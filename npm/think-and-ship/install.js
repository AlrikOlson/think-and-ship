...
async function main() {
  ...
  console.error(
    `${BIN_NAME}: could not install. Either:\n` +
      ...
      `  2. Install Rust (https://rustup.rs) and run: cargo install think-and-ship\n` +
      `Continuing anyway so the install does not fail; the cli wrappers will still print help.`
  );
}
