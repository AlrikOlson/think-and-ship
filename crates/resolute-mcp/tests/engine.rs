...
use resolute_mcp::domain::artifact::{Artifact, ArtifactType};
use resolute_mcp::domain::check::CheckType;
use resolute_mcp::domain::objective::ObjectiveStatus;
use resolute_mcp::domain::task::{TaskStatus, TaskType};
use resolute_mcp::engine::ResoluteEngine;

fn engine() -> ResoluteEngine {
    ResoluteEngine::new("test-project-abc123".to_string())
}
