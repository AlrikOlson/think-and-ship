...
use super::service::ResoluteService;
use crate::domain::action::ActionType;
use crate::domain::artifact::{Artifact, ArtifactType};
...
impl ResoluteService {
    ...
    pub async fn resolute_set_objective(
        &self,
    ...
    pub async fn resolute_complete(
        &self,
