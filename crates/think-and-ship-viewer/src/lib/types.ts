...
// and the think-and-ship Rust schema. Kept narrow on purpose — anything
...
export function projectOf(sessionId: string, history?: ThinkHistory): string {
...
export type FrontendEvent =
  ...
  | { kind: "step_appended"; session_id: string; step: ThinkStep }
  | {
      kind: "step_revised";
      session_id: string;
      revised_step: number;
