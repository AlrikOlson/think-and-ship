...
use super::service::DeliberateService;
...
/// module; sibling modules (notably `super::service::DeliberateService::new`)
...
impl DeliberateService {
    ...
    #[tool(
        name = "deliberate_set_branch_status",
    ...
    #[tool(
        name = "deliberate_trace_checkpoint",
