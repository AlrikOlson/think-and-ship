...
//!
//! * [`service::DeliberateService`] — the `ServerHandler` impl, including
...
//! `DeliberateService` re-exported here, plus the legacy [`crate::types`]
...
pub use service::DeliberateService;
