...
use crate::types::{Branch, DeliberateHistory, DeliberateStep, NextAction};
            ...
            if !branches.is_empty() {
                ...
                for branch in branches {
                    let status = match branch.status {
                        crate::types::BranchStatus::Active => '●',
                        crate::types::BranchStatus::Merged => '✓',
                        crate::types::BranchStatus::Abandoned => '✗',
                    };
                    lines.push(format!(
                        "  {} {} ({} steps)",
                        status,
