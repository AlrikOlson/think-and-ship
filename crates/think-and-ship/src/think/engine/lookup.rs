...
use crate::think::domain::{NextAction, ThinkStep};
use crate::think::util::text::excerpt_around;

use super::core::ReasoningServer;

impl ReasoningServer {
    /// Lookup a step by its step number, including any in branches.
    pub fn step_by_number(&self, n: u32) -> Option<ThinkStep> {
    ...
    pub fn latest_revision_of(&self, n: u32) -> Option<ThinkStep> {
    ...
    pub(crate) fn all_steps(&self) -> impl Iterator<Item = &ThinkStep> {
