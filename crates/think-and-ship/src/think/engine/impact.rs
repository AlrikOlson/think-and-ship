...
//! `think_step_impact` tool: it answers "if I revise this step,
...
use crate::think::domain::{BranchStatus, DepEdge};
...
impl ReasoningServer {
    ...
    pub fn impact_of(&self, step_number: u32) -> Result<Value, String> {
        ...
        // already on the target step; consumers can re-fetch via think_step).
