...
use crate::think::domain::{Branch, NextAction, ThinkHistory, ThinkStep};
...
impl Formatter {
    ...
    pub fn format_step_console(&self, step: &ThinkStep) -> String {
    ...
    pub fn format_step_markdown(&self, step: &ThinkStep) -> String {
    ...
    pub fn format_step_json(&self, step: &ThinkStep) -> String {
        serde_json::to_string_pretty(step).unwrap_or_else(|_| "{}".to_string())
    }

    pub fn format_branch_tree(&self, history: &ThinkHistory) -> String {
